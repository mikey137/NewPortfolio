import { faGithub, faReact, faCss3Alt, faNode} from '@fortawesome/free-brands-svg-icons'
...
const ProjectsArray = [
    {
        ...
        longDescription: "The algorithm aims to shorten the list of possible answers with each guess. It selects the word which minimizes the worst case length of the narrowed down answer list after making a guess. ",
        siteLink: 'https://62e69acb8720ed6da5e819bc--cosmic-biscuit-5ea996.netlify.app/',
    ...
    },
    {
        ...
        longDescription: "The Writer's Block uses React for the front end and Express for the back end, which is connected to an SQL database. It allows users to create an account, post stories and follow other users.",
    ...
    },
    {
        ...
        image: 'https://images.unsplash.com/photo-1524639064490-254e0a1db723?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80',
        shortDescription: 'retrieves definitions, quotes, synonyms, antonyms, and images for each word.',
        ...
        siteLink: 'https://master--magenta-frangollo-a7f9cd.netlify.app/',
        codeLink: 'https://github.com/mikey137/Dictionary-App',
        iconsArray:[faReact, faCss3Alt, faGithub]
    }
]
